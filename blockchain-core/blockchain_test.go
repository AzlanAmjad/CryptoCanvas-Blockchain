...
func TestNewBlockchain(t *testing.T) {
	...
	bc, err := NewBlockchain(storage, getRandomBlock(t, 0, types.Hash{}), "TestBlockchain", nil, nil)
...
func TestHasBlock(t *testing.T) {
	...
	// create new blockchain with the LevelDB storage
	bc, err := NewBlockchain(storage, getRandomBlock(t, 0, types.Hash{}), "TestBlockchain", nil, NewAccountStates())
	assert.Nil(t, err)
